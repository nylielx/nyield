 ...
 * - Scroll-velocity-reactive gradient border
...
const Navbar = () => {
  ...
  // Scroll-velocity-reactive gradient animation
  const { scrollY } = useScroll();
  const scrollVelocity = useVelocity(scrollY);
  // Map velocity to gradient rotation speed — clamp to prevent jitter
  ...
  // Accumulate rotation based on velocity
